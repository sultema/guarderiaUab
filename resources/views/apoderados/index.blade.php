...
<div class="box">
        ...
        <div class="box-body">
            <table id="tab1" class="table table-bordered table-striped">
                <thead>
                    <tr>
                        <th>Nombres</th><th>Paterno</th><th>Materno</th><th>CI</th><th>Telefono</th><th>Dreccion</th><th>Infantes</th><th class="acc">Acciones</th>
                    </tr>
                </thead>
                <tbody>
                @foreach($apoderados as $apoderado)
                    <tr>
                        ...
                        <ul>
                            ...
                            <li>{{$infante->nombres}} {{$infante->apaterno}} {{$infante->amaterno}} <a href="{{action('ApoderadoController@quitarinfante', [ $infante->id, $apoderado->id])}}"><i class="fa fa-fw fa-trash-o"></i></a></li>   
                            @endforeach                           
                            </ul>
                        </td>
                        <td class="acc"><a href="{{ route('apoderados.edit',$apoderado->id) }}" class="btn btn-default"><i class="fa fa-fw fa-pencil"></i></a>
                            
                            <a href="{{ action('ApoderadoController@asignarinfante', $apoderado->id) }}" class="btn btn-default"><i class="fa fa-fw fa-plug"></i></a></td>
                    </tr>
                @endforeach
                </tbody>
            </table>
