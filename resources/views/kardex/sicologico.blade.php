        ...
        <div class="box-header">
            ...
            @foreach($inscripciones as $inscripcion)
                ...
                <table id="tab1" class="table table-bordered table-striped">
                    <thead>
                        <tr>
                        <th>Fecha</th><th>Descripcion</th><th>Recomendaciones</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach($inscripcion->serviciosSicologicos as $sicologico)
                        <tr>
                            <td>{{$sicologico->fecha}}</td><td>{{$sicologico->descripcion}}</td><td>{{$sicologico->recomendaciones}}</td>
                        </tr>
