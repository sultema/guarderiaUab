...
<div class="box">
        <div class="box-header">
            <h3 class="box-title">REGISTRAR NUEVO SERVICIO DE SALUD</h3>
        </div>
        <form action="{{ route('salud.store') }}" role="form" class="form form-horizontal" method="POST">
        <div class="box-body">
        @csrf
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                <textarea rows="4" class="form-control" id="tratamiento" name="tratamiento" placeholder="Escriba tratamiento aquí..."></textarea>
                </div>
            </div> 
